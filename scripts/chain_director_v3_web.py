...
Runtime / control:
  ...
  start (daemon):       ~/ComfyUI-Deploy/comfyenv/bin/python ~/MiniMax-H3-Deploy/scripts/chain_director_v3_web.py --daemon
...
Layout under the data dir (default ~/MiniMax-H3-Deploy/.h3web_v3):
  ...
  h3web_v3.log              daemon stdout/stderr (only when --daemon)
